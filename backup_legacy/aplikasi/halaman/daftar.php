...
<div class="min-h-screen flex items-center justify-center px-4 py-12 relative overflow-hidden">
    <div class="absolute inset-0 z-0">
        <img src="https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?auto=format&fit=crop&w=1920&q=80" alt="Luxury Background" class="w-full h-full object-cover">
        <div class="absolute inset-0 bg-black/80"></div>
    </div>
    <div class="w-full max-w-2xl bg-luxury-card/90 backdrop-blur-xl p-10 md:p-14 border border-luxury-gold/20 rounded-xl shadow-[0_0_50px_rgba(197,160,89,0.1)] relative z-10 transition-all duration-500 hover:border-luxury-gold/40">
