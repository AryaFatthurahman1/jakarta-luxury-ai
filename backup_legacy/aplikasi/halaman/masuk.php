...
<div class="min-h-screen flex items-center justify-center px-6 relative overflow-hidden">
    <div class="absolute inset-0 z-0">
        <img src="https://images.unsplash.com/photo-1566073771259-6a8506099945?auto=format&fit=crop&w=1920&q=80" alt="Luxury Background" class="w-full h-full object-cover">
        <div class="absolute inset-0 bg-black/80"></div>
    </div>
    <div class="w-full max-w-md bg-luxury-card/90 backdrop-blur-xl p-10 border border-luxury-gold/20 rounded-lg shadow-2xl relative z-10 transition-all duration-500 hover:border-luxury-gold/40">
