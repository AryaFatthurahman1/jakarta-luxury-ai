-- Update All Culinary Images with Accurate Food Images Matching Each Dish
-- Each image URL is specifically chosen to match the Indonesian dish name

USE jakarta_luxury_ai;

-- Rijsttafel Modern Fusion - Indonesian rice table with multiple dishes
...
-- Wagyu Beef Maranggi - Premium beef/steak
...
-- Lobster Laksa Jakarta - Laksa soup with seafood
...
-- Kerak Telor Deluxe - Omelette/egg dish
...
-- Es Teler 77 - Fruit cocktail/drink
...
-- Gado-Gado Jakarta - Salad with vegetables
...
-- Bakso Malang Jumbo - Meatballs soup
...
-- Satay Ayam Madura - Chicken satay/skewers
...
-- Tahu Gejrot Cirebon - Fried tofu
