...
('Wagyu Beef Maranggi', 'Premium wagyu beef with traditional Sundanese maranggi spices', 'Main Course', 450000, 'Majestic Kitchen', 'Central Jakarta', 'https://images.unsplash.com/photo-1546272989-40c929ae8d6b?w=800&q=80&fit=crop', 4.9, TRUE),
('Truffle Nasi Goreng', 'Luxury fried rice with black truffle and caviar', 'Main Course', 280000, 'Nasi Goreng Mafia', 'West Jakarta', 'https://images.unsplash.com/photo-1512058560366-cd2429bb5c81?w=800&q=80&fit=crop', 4.7, TRUE),
('Lobster Laksa Jakarta', 'Premium lobster in Jakarta-style laksa with coconut milk', 'Main Course', 380000, 'Laksa Bar', 'North Jakarta', 'https://images.unsplash.com/photo-1511112232410-0925e0541793?w=800&q=80&fit=crop', 4.6, TRUE),
('Soto Betawi Premium', 'Traditional Jakarta beef soup with premium ingredients', 'Soup', 85000, 'Soto Betawi H. Husain', 'Central Jakarta', 'https://images.unsplash.com/photo-1596797038530-2c39fa81ef4f?w=800&q=80&fit=crop', 4.5, TRUE),
('Kerak Telor Deluxe', 'Traditional Jakarta omelette with sticky rice and premium toppings', 'Snack', 45000, 'Kerak Telor Vendor', 'Old Jakarta', 'https://images.unsplash.com/photo-1541544741938-0af808871cc0?w=800&q=80&fit=crop', 4.3, TRUE),
('Es Teler 77', 'Traditional Indonesian fruit cocktail with coconut milk', 'Dessert', 35000, 'Es Teler 77', 'South Jakarta', 'https://images.unsplash.com/photo-1505252585441-dfdecb32c66f?w=800&q=80&fit=crop', 4.4, TRUE),
('Gado-Gado Jakarta', 'Traditional Indonesian salad with peanut sauce', 'Salad', 55000, 'Gado-Gado Jakarta', 'Central Jakarta', 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=800&q=80&fit=crop', 4.2, TRUE),
...
('Nasi Uduk Betawi', 'Fragrant coconut rice with fried chicken, egg, and sriracha', 'Main Course', 55000, 'Nasi Uduk Betawi', 'Central Jakarta', 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=800&q=80&fit=crop', 4.4, FALSE),
...
('Klepon', 'Sweet rice balls filled with palm sugar and coated in coconut', 'Dessert', 20000, 'Klepon Vendor', 'East Jakarta', 'https://images.unsplash.com/photo-1551024601-bec78aea704b?w=800&q=80&fit=crop', 4.1, FALSE);
